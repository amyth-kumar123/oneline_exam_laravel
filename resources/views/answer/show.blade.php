...
<body style="background-color: darkseagreen">
    <div>
        ...
        <h1 class="col-lg-offset-4" style="color: red; align:center"><span style="background-color:seagreen;color: white;border-radius: 5px"><b>  Examination on {{$course}}  </b></span></h1>
            ...
            <div class="panel panel-default">
                <form method="post" action="{{route('answer.store')}}" class="ansform">
                    ...
                    <div class="col-lg-offset-1" >
                        ...
                        <input type="submit" name="submit" value="Submit" class="btn btn-primary" id="submitbtn" style="margin:0px auto; display:block;">
                    </div>
                 </form>
            </div>
         @endforeach
	<a href="/"><button type="button" class="btn btn-info btn-lg btn-block"> Click Here if Done </button></a><br>
        </div>
    </div>
