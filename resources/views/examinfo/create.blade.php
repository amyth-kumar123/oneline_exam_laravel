...
<form method="post" action="{{route('examinfo.store')}}">
	...
	<div class="col-md-6 col-lg-6 col-sm-6 col-lg-offset-3">
	  <div class="form-group">
	    <label class="col-form-label" for="formGroupExampleInput">Examiner ID</label>
	    <input type="text" name="Teacher_id" class="form-control " id="formGroupExampleInput" placeholder="example:someone111" required>
	  </div>
	  <div class="form-group">
	    <label class="col-form-label" for="formGroupExampleInput2">Language Name</label>
	  ...
	  <div class="form-group">
	    <label class="col-form-label" for="formGroupExampleInput2">Qualifying Marks</label>
	    <input type="text" name="qualifying_marks" class="form-control" id="formGroupExampleInput2" placeholder="E.g 10" required>
	  </div>
	  <div class="form-group">
